...
public class ContainersImpl implements Containers {
    ...
    public Single<RestResponse<ContainerDeleteHeaders, Void>> deleteWithRestResponseAsync() {
        ...
        return service.delete(this.client.accountUrl(), timeout, leaseId, ifModifiedSinceConverted, ifUnmodifiedSinceConverted, this.client.version(), requestId, restype);
    }
    ...
    public Single<RestResponse<ContainerSetAclHeaders, Void>> setAclWithRestResponseAsync() {
        ...
        return service.setAcl(this.client.accountUrl(), new SignedIdentifiersWrapper(containerAcl), timeout, leaseId, access, ifModifiedSinceConverted, ifUnmodifiedSinceConverted, this.client.version(), requestId, restype, comp);
    }
    ...
    public Single<RestResponse<ContainerListBlobsHeaders, ListBlobsResponse>> listBlobsWithRestResponseAsync() {
        ...
        return service.listBlobs(this.client.accountUrl(), prefix, delimiter, marker, maxresults, includeConverted, timeout, this.client.version(), requestId, restype, comp);
    }
